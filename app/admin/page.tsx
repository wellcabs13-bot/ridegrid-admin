    ...
    <DashboardLayout>
      <PageContainer>
            ...
            <div className="flex flex-col gap-10 xl:flex-row xl:items-center xl:justify-between">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                  Monitor every booking, vehicle, driver, vendor, finance
                  transaction and customer from one intelligent enterprise
                  platform.
                </p>
                ...
                <div className="mt-10 flex flex-wrap gap-4">
                  ...
                  <Link
                    href="/marketplace"
                    className="rounded-xl bg-white px-7 py-3 font-semibold text-slate-900 transition hover:scale-105"
                  >
                    + New Booking
                  </Link>
                  ...
                  <Link
                    href="/reports"
                    className="rounded-xl border border-white/20 bg-white/10 px-7 py-3 backdrop-blur transition hover:bg-white/20"
                  >
                    View Reports
                  </Link>
        ...
        <div className="mt-10 grid gap-6 xl:grid-cols-2">
          ...
          <InfoCard title="AI Business Insights">
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-2xl bg-blue-50 p-4">
                ...
                <p className="mt-1 text-sm text-blue-700">
                  Revenue is trending upward with an 18% increase today.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-emerald-50 p-4">
                ...
                <p className="mt-1 text-sm text-emerald-700">
                  Fleet availability remains healthy across active operations.
                </p>
              </div>
