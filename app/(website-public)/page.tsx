...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { alternates: { canonical: "https://www.wellcabs.com/" }, openGraph: { title: "RideGrid by Wellcabs", description: "Search current cab, airport, local and outstation ride options.", url: "https://www.wellcabs.com/", type: "website", images }, twitter: { card: image ? "summary_large_image" : "summary", images } };
}
