...
export async function GET(
  ...
  try {
    ...
    switch (report) {
      ...
      case "booking":
        data =
          await reportsService.getBookingReport(
            filters
          );
        break;
      ...
      case "vendor":
        data =
          await reportsService.getVendorReport(
            filters
          );
        break;
      ...
      case "driver":
        data =
          await reportsService.getDriverReport(
            filters
          );
        break;
      ...
      case "gst":
        data =
          await reportsService.getGSTReport(
            filters
          );
        break;
      ...
      case "corporate":
        data =
          await reportsService.getCorporateReport(
            filters
          );
        break;
