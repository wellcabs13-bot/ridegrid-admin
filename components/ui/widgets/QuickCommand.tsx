    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        {commands.map((command) => {
          ...
          return (
            <Link
              key={command.title}
              href={command.href}
              className="group block overflow-hidden rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl"
            >
              <div
      ...
      <div className="mt-8 rounded-2xl bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500 p-6 text-white">
        ...
        <p className="mt-3 text-sm leading-6 opacity-90">
          Use Quick Commands to reduce booking creation time by up to{" "}
          <strong>65%</strong>. Frequently used actions are automatically
          prioritized based on your daily workflow.
        </p>
      </div>
